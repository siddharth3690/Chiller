...
type SignupScreenRouteProp = RouteProp<LoginPageParams, "SignupScreen">;
...
const EmailScreen = () => {
  ...
  const handleContinue = async () => {
    ...
    console.log("this is from email screen", name , phone);
    ...
    try {
      ...
      // 2. If email does not exist, send OTP
      ...
      navigation.navigate('OtpScreen', { email: email.trim() , name : name , phone : phone});
